          ...
          {featureData.map(({ key, icon: Icon, gradient, span }, index) => (
            ...
            >
              <SpotlightCard className="h-full">
                <div className="group relative overflow-hidden rounded-2xl border border-border/50 bg-white h-full p-6 sm:p-8 md:p-10 hover:shadow-xl transition-all duration-500">
                  ...
                  <div
                    className={`w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br ${gradient} flex items-center justify-center mb-5 sm:mb-6 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}
                  >
